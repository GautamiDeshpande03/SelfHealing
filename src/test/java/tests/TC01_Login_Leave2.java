...
public class TC01_Login_Leave2 extends DriverSetup {

    private WebDriver driver;
    private LoginPage loginPage;
    public String url= "https://qa-wagonhr.mouritech.net/";
    public String employee_username= "employee1";
    public String employee_password= "Welcome@123";
